...
class EnvironmentVariables:
    ...
    OPC_UA_USERNAME: str | None = os.getenv("OPC_UA_USERNAME")
    OPC_UA_PASSWORD: str | None = os.getenv("OPC_UA_PASSWORD")
    OPC_UA_TIMEOUT: int = _env_int("OPC_UA_TIMEOUT", 10)

    OPC_DA_SERVER: str | None = os.getenv("OPC_DA_SERVER")
    OPC_DA_HOST: str = os.getenv("OPC_DA_HOST", "localhost")
    OPC_DA_TIMEOUT: int = _env_int("OPC_DA_TIMEOUT", 10)
...
class OpcUaConfigsCreds(Enum):
    OPC_UA_ENDPOINT = dotenv_var.OPC_UA_ENDPOINT
    OPC_UA_USERNAME = dotenv_var.OPC_UA_USERNAME
    OPC_UA_PASSWORD = dotenv_var.OPC_UA_PASSWORD
    OPC_UA_TIMEOUT = dotenv_var.OPC_UA_TIMEOUT


class OpcDaConfigsCreds(Enum):
    OPC_DA_SERVER = dotenv_var.OPC_DA_SERVER
    OPC_DA_HOST = dotenv_var.OPC_DA_HOST
    OPC_DA_TIMEOUT = dotenv_var.OPC_DA_TIMEOUT
