...
class ConfigProjectUseCase(use_cases.OSInterface):
    ...
    def __run_setup_wizard(self, project_name: str) -> entities.ProjectConfigSchema:
        ...
        dao_dir = self.__prompt_optional(
            ...
            default=get_default(
                ["project_root", "dao_output_code", 0, "directory"],
        ...
        dto_dir = self.__prompt_optional(
            ...
            default=get_default(
                ["project_root", "dto_output_code", 0, "directory"],
        ...
        api_dir = self.__prompt_optional(
            ...
            default=get_default(
                ["project_root", "api_output_code", 0, "directory"],
        ...
        test_routes_dir = self.__prompt_optional(
            ...
            default=get_default(
                ["project_root", "test_api_output_code", 0, "directory"],
        ...
        dao_prog_lang = self.__prompt_optional(
            ...
            default=get_default(
                ["project_root", "dao_output_code", 0, "language"], "python"
            ),
        )
        dto_prog_lang = self.__prompt_optional(
            "Enter the programming language for DTO generation",
            default=get_default(
                ["project_root", "dto_output_code", 0, "language"], "python"
            ),
        )
    ...
    def execute(
        ...
        """Build project configuration via an input wizard.
        ...
        if (
            ...
            or self.update_existing_config
        ):
